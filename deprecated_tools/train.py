...
from sc.utils.lr_scheduler import build_lr_scheduler
from sc.utils.log_helper import init_log, print_speed, add_file_handler
from sc.utils.distributed import dist_init, DistModule, reduce_gradients,\
        average_reduce, get_rank, get_world_size
from sc.utils.model_load import load_pretrain, restore_from
from sc.utils.average_meter import AverageMeter
from sc.utils.misc import describe, commit
from sc.models.model_builder import ModelBuilder
from sc.dataset.dataflow import get_train_dataflow
...
def build_opt_lr(model, current_epoch=0):
    ...
    def _freeze_or_not(net, is_frozen, train_layers=[]):
        if is_frozen:
            ...
            for layer in train_layers:
                for param in getattr(net, layer).parameters():
    ...
    _freeze_or_not(model.backbone, cfg.TRAIN.FREEZE_BACKBONE, cfg.TRAIN.BACKBONE_TRAIN_LAYERS)
    _freeze_or_not(model.neck, cfg.TRAIN.FREEZE_NECK)
