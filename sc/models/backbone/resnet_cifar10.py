...
model_urls = {
    'resnet18_cifar': 'https://download.pytorch.org/models/resnet18-5c106cde.pth',
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        # for cifar10, set stride = 1 for layer3 and 4
...
def resnet18_cifar(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet18_cifar', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
...
def resnet34_cifar(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34_cifar', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
