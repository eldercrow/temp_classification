...
__C.PREPROC.IMAGE_HW = (224, 224)
__C.PREPROC.BATCH_SIZE = 128

__C.PREPROC.EVAL_NUM_WORKERS = 1
__C.PREPROC.EVAL_IAMGE_HW = (224, 224)
__C.PREPROC.EVAL_BATCH_SIZE = 128
...
__C.DATASET.TRAIN.NAME_DOMAINS = ['VISDA_CLIPART', 'VISDA_SKETCH']

__C.DATASET.TRAIN.VISDA_CLIPART = CN()
__C.DATASET.TRAIN.VISDA_CLIPART.ROOT = '~/dataset/visda'
__C.DATASET.TRAIN.VISDA_CLIPART.ANNO = '~/dataset/visda/clipart_train.txt'
__C.DATASET.TRAIN.VISDA_CLIPART.NUM_USE = -1
__C.DATASET.TRAIN.VISDA_CLIPART.NUM_INIT_USE = -1

__C.DATASET.TRAIN.VISDA_SKETCH = CN()
__C.DATASET.TRAIN.VISDA_SKETCH.ROOT = '~/dataset/visda'
__C.DATASET.TRAIN.VISDA_SKETCH.ANNO = '~/dataset/visda/sketch_train.txt'
__C.DATASET.TRAIN.VISDA_SKETCH.NUM_USE = -1
__C.DATASET.TRAIN.VISDA_SKETCH.NUM_INIT_USE = -1

# evaluation
__C.DATASET.EVAL = CN(new_allowed=True)
__C.DATASET.EVAL.NAME_DOMAINS = ['VISDA_SKETCH']

__C.DATASET.EVAL.VISDA_SKETCH = CN()
__C.DATASET.EVAL.VISDA_SKETCH.ROOT = '~/dataset/visda'
__C.DATASET.EVAL.VISDA_SKETCH.ANNO = '~/dataset/visda/sketch_test.txt'
__C.DATASET.EVAL.VISDA_SKETCH.NUM_USE = -1
__C.DATASET.EVAL.VISDA_SKETCH.NUM_INIT_USE = -1
